				...
				<div class="card-content">
						<div class="item-content" style="padding:6px">
							...
							<div class="card_list_content">
								...
								<div class="item-title-row">`+ resultSet.rows.item(r).vendorename + `<span class="price_in_card">` + resultSet.rows.item(r).CurrencyName + resultSet.rows.item(r).Price + `</span></div>
							</div>
						</div>
				</div>
